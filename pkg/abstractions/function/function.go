...
type RemoteFunctionService struct {
...
func NewRemoteFunctionService(ctx context.Context,
...
func (fs *RemoteFunctionService) FunctionInvoke(in *pb.FunctionInvokeRequest, stream pb.FunctionService_FunctionInvokeServer) error {
...
func (fs *RemoteFunctionService) invoke(ctx context.Context, authInfo *auth.AuthInfo, stubId string, payload *types.TaskPayload) (types.TaskInterface, error) {
...
func (fs *RemoteFunctionService) functionTaskFactory(ctx context.Context, msg types.TaskMessage) (types.TaskInterface, error) {
	return &FunctionTask{
		msg: &msg,
		fs:  fs,
	}, nil
...
func (fs *RemoteFunctionService) stream(ctx context.Context, stream pb.FunctionService_FunctionInvokeServer, authInfo *auth.AuthInfo, task types.TaskInterface, stubId string, headless bool) error {
...
func (fs *RemoteFunctionService) FunctionGetArgs(ctx context.Context, in *pb.FunctionGetArgsRequest) (*pb.FunctionGetArgsResponse, error) {
...
func (fs *RemoteFunctionService) FunctionSetResult(ctx context.Context, in *pb.FunctionSetResultRequest) (*pb.FunctionSetResultResponse, error) {
	authInfo, _ := auth.AuthInfoFromContext(ctx)
...
func (fs *RemoteFunctionService) FunctionMonitor(req *pb.FunctionMonitorRequest, stream pb.FunctionService_FunctionMonitorServer) error {
	authInfo, _ := auth.AuthInfoFromContext(stream.Context())
...
func (fs *RemoteFunctionService) genContainerId(taskId, stubType string) string {
	return fmt.Sprintf("%s-%s-%s", stubType, taskId, uuid.New().String()[:8])
}

func (fs *RemoteFunctionService) FunctionSchedule(ctx context.Context, req *pb.FunctionScheduleRequest) (*pb.FunctionScheduleResponse, error) {
	authInfo, _ := auth.AuthInfoFromContext(ctx)
...
func (fs *RemoteFunctionService) listenForScheduledJobs() {
