...
func (x *ExecInPodRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecInPodRequest) ProtoMessage() {}

func (x *ExecInPodRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pod_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExecInPodRequest.ProtoReflect.Descriptor instead.
func (*ExecInPodRequest) Descriptor() ([]byte, []int) {
	return file_pod_proto_rawDescGZIP(), []int{2}
}

func (x *ExecInPodRequest) GetStubId() string {
	if x != nil {
		return x.StubId
	}
	return ""
...
func (x *ExecInPodRequest) GetContainerId() string {
	if x != nil {
		return x.ContainerId
	}
	return ""
...
func (x *ExecInPodRequest) GetCommand() []string {
	if x != nil {
		return x.Command
	}
	return nil
...
func (x *ExecInPodResponse) Reset() {
	*x = ExecInPodResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ExecInPodResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecInPodResponse) ProtoMessage() {}

func (x *ExecInPodResponse) ProtoReflect() protoreflect.Message {
	mi := &file_pod_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExecInPodResponse.ProtoReflect.Descriptor instead.
func (*ExecInPodResponse) Descriptor() ([]byte, []int) {
	return file_pod_proto_rawDescGZIP(), []int{3}
}

func (x *ExecInPodResponse) GetOutput() string {
	if x != nil {
		return x.Output
	}
	return ""
...
func (x *ExecInPodResponse) GetErrorMsg() string {
	if x != nil {
		return x.ErrorMsg
	}
	return ""
...
func (x *ExecInPodResponse) GetDone() bool {
	if x != nil {
		return x.Done
	}
	return false
...
func (x *ExecInPodResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *ExecInPodResponse) GetExitCode() int32 {
	if x != nil {
		return x.ExitCode
	}
	return 0
...
var file_pod_proto_rawDesc = []byte{
	...
	0x73, 0x67, 0x22, 0x68, 0x0a, 0x10, 0x45, 0x78, 0x65, 0x63, 0x49, 0x6e, 0x50, 0x6f, 0x64, 0x52,
	...
	,
...
var file_pod_proto_goTypes = []interface{}{
	...
	(*ExecInPodRequest)(nil),  // 2: pod.ExecInPodRequest
	(*ExecInPodResponse)(nil), // 3: pod.ExecInPodResponse
}
var file_pod_proto_depIdxs = []int32{
	0, // 0: pod.PodService.CreatePod:input_type -> pod.CreatePodRequest
	2, // 1: pod.PodService.ExecInPod:input_type -> pod.ExecInPodRequest
	1, // 2: pod.PodService.CreatePod:output_type -> pod.CreatePodResponse
	3, // 3: pod.PodService.ExecInPod:output_type -> pod.ExecInPodResponse
...
func file_pod_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pod_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExecInPodResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
